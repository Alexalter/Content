...
<table width="100%" border="0">
    <tr>
        <td style="background: none repeat scroll 0% 0% transparent ! important;" width="25%">{if $prevpage}
            ...
            {/if}</td>
        <td style="background: none repeat scroll 0% 0% transparent ! important;" align="center"><a href="{modurl modname='Content' type='user' pid=$page.parentPageId}">{gt text="Overview"}</a></td>
